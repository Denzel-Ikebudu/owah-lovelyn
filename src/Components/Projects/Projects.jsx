...
import project4 from '../../assets/Lead magnet 1.pdf'
import project5 from '../../assets/Top content formats.pdf'
import project6 from '../../assets/Weekly_Newsletters_Email_Templates_SimplifiVAs (1).pdf'
    ...
    <div className='project-container' id='projects-section' data-aos="slide-up">
      ...
      <div className={`project-box ${expandedBox === 'boxA' ? 'expanded' : ''}`}>
        <div className='project-header' onClick={() => handleBoxClick('boxA')}>
          ...
          <FaFolderOpen size={32} color="#04012d" style={{ marginBottom: '8px' }} />
        </div>
              ...
              {expandedBox === 'boxA' && (
                <>
                  <div className='each-box'>
                    ...
                    <a href={project1} download className="download-btn">
                      Download
                    </a>
                  </div>
                  <div className='each-box'>
                    <iframe src={project2} title="" />
                    <a href={project2} download className="download-btn">
                      Download
                    </a>
                  </div>
                  ...
                  <div className='each-box'>
                    ...
                    <a href={project5} download className="download-btn">
                      Download
                    </a>
                  </div>
                  <div className='each-box'>
                    <iframe src={project4} title="" />
                    <a href={project4} download className="download-btn">
                      Download
                    </a>
                  </div>
                  <div className='each-box'>
                    <iframe src={project6} title="" />
                    <a href={project6} download className="download-btn">
                      Download
                    </a>
                  </div>
                </>
      ...
      <div className={`project-box ${expandedBox === 'boxB' ? 'expanded' : ''}`}>
        ...
        <div className="project-content">
          <p>Here's a detailed report on the work I did for Voulay company.<br />
            Click to view or download the documents .</p>
          <div className="document-container">
            {expandedBox === 'boxB' && (
              <>
